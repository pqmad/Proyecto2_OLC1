...
function elseif (instruccion, _ambito,_Error) {
    mensaje=""
    const primerif = Operacion(instruccion.expresion, _ambito,_Error);
    ...
    if(primerif.tipo=== TIPO_DATO.BANDERA){
        if (primerif.valor){
            ...
            mensaje= Bloque(instruccion.instrucciones, nuevoAmbito,_Error);
        }else{
